...
<head>
    ...
    <style>
        ...
        .sidebar-dark-primary .nav-link.active {
            background-color: #22c55e; /* verde lima claro */
            color: #000;
        }
        .brand-link {
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Municipio de Chiclayo</span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid d-flex">
                    <button class="btn btn-success btn-agregar" data-toggle="modal" data-target="#modal-denuncia">Agregar Denuncia</button>
                </div>
                <div class="container-fluid">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="index.php?c=DenunciaController&a=registrarDenuncia" method="POST">
                            ...
                            <button type="submit" class="btn btn-success">Registrar Denuncia</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="index.php?c=DenunciaController&a=actualizarDenuncia" method="POST" id="actualizar-denuncia-form">
                            ...
                            <button type="submit" class="btn btn-success">Actualizar Denuncia</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025 <a href="#">Municipalidad de Chiclayo</a>.</strong> All Rights Reserved.
        </footer>
    </div>
